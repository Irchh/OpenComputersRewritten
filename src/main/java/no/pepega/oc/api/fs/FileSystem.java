 ...
 * <br>
 * See {@link no.pepega.oc.api.FileSystem} for factory methods.
 * <br>
...
public interface FileSystem extends Persistable {
     ...
     * one of the factory functions in {@link no.pepega.oc.api.FileSystem} this
