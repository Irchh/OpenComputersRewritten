 ...
 * in {@link no.pepega.oc.api.Network} to create and join networks.
 */
public interface Network {
     ...
     * {@link net.minecraft.block.entity.BlockEntity#markRemoved()}) or unloaded
     * (e.g. in {@link net.minecraft.block.entity.BlockEntity#onChunkUnloaded()}).
