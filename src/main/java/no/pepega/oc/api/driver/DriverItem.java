...
public interface DriverItem {
     ...
     */
    ManagedEnvironment createEnvironment(ItemStack stack, no.pepega.oc.api.network.EnvironmentHost host);
     ...
     * @see no.pepega.oc.api.driver.item.SlotType
     */
    SlotType slot(ItemStack stack);
     ...
     */
    NbtCompound dataTag(ItemStack stack);
}