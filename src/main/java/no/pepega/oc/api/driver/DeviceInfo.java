...
/**
 * Implement this on {@link no.pepega.oc.api.network.Environment}s if you wish to
 * expose some (typically static) information about the device represented by
 * that environment to a {@link no.pepega.oc.api.Machine} connected to it.
 * <br>
 * You may also implement this on a {@link no.pepega.oc.api.machine.MachineHost}
