...
import no.pepega.oc.api.detail.Builder;
 ...
 * since the {@link no.pepega.oc.api.API#network} may not have been initialized
 * at that time. Only start calling these methods in the init phase or later.
 */
public final class Network {
    /**
     * Convenience overload for {@link #joinOrCreateNetwork(BlockView, BlockPos)}.
     * <br>
     ...
     * <br>
     * If the tile entity is a {@link no.pepega.oc.api.network.SidedEnvironment}
     ...
     */
    public static void joinOrCreateNetwork(final BlockView world, final BlockPos pos) {
        if (API.network != null)
     ...
     */
    public static Packet newPacket(final NbtCompound nbt) {
        if (API.network != null)
