 ...
 * have it implement {@link no.pepega.oc.api.network.Environment} - no driver is
 * needed in that case.
 * <br>
 * Note that these methods should <em>not</em> be called in the pre-init phase,
 * since the {@link no.pepega.oc.api.API#driver} may not have been initialized
...
public final class Driver {
     ...
     * @return the Storage<ItemVariant> implementation interfacing the stack, or <tt>null</tt>.
     */
    public static Storage<ItemVariant> itemHandlerFor(ItemStack stack, PlayerEntity player) {
        if (API.driver != null)
