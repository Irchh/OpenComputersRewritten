...
public final class Items {
     ...
     * since the {@link no.pepega.oc.api.API#items} may not have been initialized
     ...
     */
    public static ItemStack registerFloppy(String name, Identifier loc, DyeColor color,
                                           Callable<no.pepega.oc.api.fs.FileSystem> factory, boolean doRecipeCycling) {
