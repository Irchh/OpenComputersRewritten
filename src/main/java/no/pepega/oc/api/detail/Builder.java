...
/**
 * Used for building {@link Node}s via {@link no.pepega.oc.api.Network#newNode}.
 *
...
public interface Builder<T extends Node> {
    ...
    public static interface NodeBuilder extends Builder<Node> {
         ...
         * declared in them marked using the {@link no.pepega.oc.api.machine.Callback} annotation can
         ...
         * @see no.pepega.oc.api.network.Component
         */
         ...
         * @see no.pepega.oc.api.network.Connector
         */
