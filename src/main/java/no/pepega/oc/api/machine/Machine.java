 ...
 * method {@link no.pepega.oc.api.Machine#create(MachineHost)}.
 */
...
public interface Machine extends ManagedEnvironment, Context {
     ...
     * whenever the host calls {@link no.pepega.oc.api.machine.Machine#onHostChanged()}.
     *
     ...
     * <br>
     * The specified object can be either a {@link no.pepega.oc.api.machine.Value}
     * or a {@link no.pepega.oc.api.network.Environment}. This is useful for
