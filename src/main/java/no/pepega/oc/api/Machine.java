 ...
 * <br>
 * It also allows registering new {@link no.pepega.oc.api.machine.Architecture}s,
 ...
 * since the {@link no.pepega.oc.api.API#machine} may not have been initialized
...
public final class Machine {
     ...
     */
    public static no.pepega.oc.api.machine.Machine create(MachineHost host) {
        if (API.machine != null)
